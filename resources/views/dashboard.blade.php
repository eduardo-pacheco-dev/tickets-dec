        ...
        <div class="space-y-6 sm:space-y-8">
                    ...
                    <a href="{{ route('admin.users.index') }}" wire:navigate class="transition hover:opacity-90">
                        <flux:card class="flex items-center gap-3 sm:gap-4">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="mt-1 text-xs font-medium text-zinc-500 dark:text-zinc-400">Usuários</p>
                            </div>
                        </flux:card>
                    </a>
                    ...
                    <div>
                        <flux:card class="flex items-center gap-3 sm:gap-4">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="mt-1 text-xs font-medium text-zinc-500 dark:text-zinc-400">Hoje</p>
                            </div>
                        </flux:card>
                    </div>
                @endif
            ...
            <div class="grid gap-6 lg:grid-cols-3 lg:gap-8">
                ...
                <div class="lg:col-span-2">
                    <flux:card class="overflow-hidden p-0!">
                        <div class="flex items-center justify-between border-b border-zinc-200 px-5 py-4 dark:border-white/10">
                            <flux:heading>Tickets recentes</flux:heading>
                        ...
                        @if ($recentTickets->isEmpty())
                            <div class="flex flex-col items-center justify-center gap-3 px-6 py-16 text-center">
                                ...
                                <flux:text>Nenhum ticket ainda.</flux:text>
                            </div>
                        @else
                ...
                <div class="space-y-6 lg:space-y-8">
                    ...
                    <flux:card class="p-0!">
                        <div class="flex items-center justify-between border-b border-zinc-200 px-5 py-4 dark:border-white/10">
                            <flux:heading>Fila pendente</flux:heading>
                        ...
                        @if ($pending->isEmpty())
                            <div class="flex flex-col items-center justify-center gap-3 px-6 py-14 text-center">
                                ...
                                <flux:heading size="sm">Tudo em dia!</flux:heading>
                                <flux:text>Nenhum ticket aguardando.</flux:text>
                            </div>
                        @else
                    ...
                    {{-- Ações rápidas --}}
                    <flux:card>
                        <flux:heading class="mb-4">Ações rápidas</flux:heading>
    ...
    @else
        <div class="flex min-h-[70vh] flex-col items-center justify-center py-16 text-center">
            ...
            <flux:text class="mx-auto mt-3 max-w-md">
                Crie um ticket para reportar um problema ou acompanhe o status de um ticket existente pelo código de acompanhamento.
            </flux:text>
            ...
            <div class="mt-10 grid w-full max-w-xl gap-4 sm:grid-cols-2">
                <a href="{{ route('home') }}" wire:navigate class="group">
                    <flux:card class="h-full text-left transition group-hover:border-zinc-300 group-hover:shadow-md dark:group-hover:border-white/20">
                        ...
                        <flux:heading>Abrir Ticket</flux:heading>
                        <flux:text class="mt-1.5">Reporte um novo problema para nossa equipe.</flux:text>
                    </flux:card>
                </a>
                ...
                <a href="{{ route('tickets.status') }}" wire:navigate class="group">
                    <flux:card class="h-full text-left transition group-hover:border-zinc-300 group-hover:shadow-md dark:group-hover:border-white/20">
                        ...
                        <flux:heading>Acompanhar Ticket</flux:heading>
                        <flux:text class="mt-1.5">Consulte o status pelo seu código de acompanhamento.</flux:text>
                    </flux:card>
                </a>
            </div>
        </div>
